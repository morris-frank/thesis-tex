...
\begin{figure}
    \includegraphics{train_toy_noiseless.pdf}
...
\begin{figure}
    \includegraphics{train_musdb_noiseless.pdf}
...
\begin{figure}
    ...
    \caption{The log likelihood of each source under each prior for both sets of priors. Notice how for the ToyData we get the diagonal that we are expecting while for the for the real music the likelihood for every field is high and in the same range. The \I{other} prior assigns the highest likelihoods.}%
