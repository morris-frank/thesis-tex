...
{\color{red} is there something missing here? I guess so.}
\begin{tcolorbox}
    \begin{enumerate}
        \item Can we learn a source separation model \(g(\·)\) by learning deep priors for the different source classes. {\color{red}If it is a question, it should have a question mark}
