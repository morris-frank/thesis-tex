...
\begin{algorithm}
    ...
    \begin{algorithmic}[1]
        \While{Training is not converged}
            \State \(\B{X} \sim \mathcal{D}\)\Comment{Sample random mini-batch}
