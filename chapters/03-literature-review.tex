...
In~\autocite{lluisEndtoend2019} the authors were first to apply a time-domain WaveNet for musical source separation. They adapted the WaveNet to be non-causal, meaning a predicted value is in the middle of its receptive field. The model was directly end-to-end trained, outputting the \(k\) sources given an input mix.
