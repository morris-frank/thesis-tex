...
In general this research work is build on prior work first on deep generative models, or laten models, which try to estimate the distribution / density of a data space to find smooth manifolds. Second we will give an overview of contemporary works on using deep models for music and speech analysis and generation.
